    ...
    return (
        <div className="login-form">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-group">
                    ...
                    <div className="password-wrapper">
                        <img className="input-icon" src="/icons/carbon-password.svg" alt="" />
                        <input
                    ...
                    {errors.hashed_password && <p className="error-message">{errors.hashed_password.message}</p>}
                </div>
                ...
                <button
                    type="submit"
                    className={`login-button ${!isFormFilled || isBlocked ? 'disabled' : ''}`}
            ...
            <p className="auth-switch">
                ...
                <button className="admin-link" onClick={() => setAdminInfoModalOpen(true)}>
